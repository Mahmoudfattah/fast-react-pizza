...
const cartSlice = createSlice({
    ...
    reducers:{
        ...
        increaseQuantityItem(state,action){
            //item now the { } that have the same id from payload
...
export const {addItem,deleteItem,increaseQuantityItem,decreaseQuantityItem,clear} = cartSlice.actions;

export default cartSlice.reducer;

export const getTotalQuantity= (state)=> state.cart.cart.reduce((sum,item)=>
  sum+ item.quantity,0)
